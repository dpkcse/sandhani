					...
					<div class="row">
						<div class="col-md-6">
							<div id="page-slide" class="owl-carousel owl-theme page-slide">
								<div class="item">
									<img class="img-responsive" src="images/slider-pages/slide-page1.jpg" alt="">
								</div>

								<div class="item">
									<img class="img-responsive" src="images/slider-pages/slide-page2.jpg" alt="">
								</div>

								<div class="item">
									<img class="img-responsive" src="images/slider-pages/slide-page3.jpg" alt="">
								</div>
							</div><!-- Owl carousel -->
						...
						<div class="col-md-6">
							<h3 class="page-content-title first">What Does Sandhani Means</h3>
